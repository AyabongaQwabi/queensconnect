...
- fetch_news_tool — Get local news. When the user asks to see the latest news, view news, or get headlines (e.g. "I'd like to see the latest news", "what's in the news"), use fetch_news_tool and reply with each item's **title** and **link** so they can click through.
